...
<body>
  ...
  <div id="container">
    ...
    <div id="header">
      ...
      <div style="float:right; margin-top:10px; text-align:center"><a style="color:white;" href="http://manage.aff.biz/z/90/CD3964/"><img style="display:block;" src="http://manage.aff.biz/42/3964/90/" alt="" border="0"><span>GotDrupal.com recommends ANHosting for Drupal friendly hosting!</span></a></div>
      <!-- site name -->
      <?php if ($site_name) : ?>
        <h1>
	  <a href="<?php print $base_path ?>" title="<?php print t('Home') ?>">
    ...
    <!-- begin mainContent -->
    <div id="mainContent" style="width: <?php print amadou_gotdrupal_get_mainContent_width( $sidebar_left, $sidebar_right) ?>px;">
    ...
    <div id="sideBars-bg" style="width: <?php print amadou_gotdrupal_get_sideBars_width( $sidebar_left, $sidebar_right) ?>px;">
      <div id="sideBars" style="width: <?php print amadou_gotdrupal_get_sideBars_width( $sidebar_left, $sidebar_right) ?>px;">
